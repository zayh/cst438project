...
class TestRating(unittest.TestCase):
  ...
  def test_JSON(self):
    ...
    # Get a rating from the database now
    object3 = Rating()
    object3.getRow(4)
    object4 = Rating()
    object4.fromJSON(object3.toJSON())
    self.assertEqual(object4.getItem('rating_id'), 4)
  ...
  def test_getByRatingID(self):
    ...
    theDate = object.getItem('date')
    self.assertEqual(object.getItem('date').isoformat(), '2018-03-31' )
